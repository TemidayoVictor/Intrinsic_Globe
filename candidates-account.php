...
if(isset($_SESSION['msgPersonal'])) {
    $msg = $_SESSION['msgPersonal'];
    $msgClass = $_SESSION['msgClassPersonal'];
}
else {
    $msg = "";
    $msgClass = "";
...
if(isset($_SESSION['msgPersonal2'])) {
    $msg2 = $_SESSION['msgPersonal2'];
    $msgClass2 = $_SESSION['msgClassPersonal2'];
}
else {
    $msg2 = "";
    $msgClass2 = "";
            ...
            <div class="container-cover">    
                <div class="container active selected" style="margin-top: -10px;"  id="1">
                    <div class="body">
                        ...
                        <form action="phpFiles/includes/signup-candidate.php" method="post" enctype="multipart/form-data">
                            <div class="section">
                                ...
                                <div class="section-body">
                                    <div class="details">
                                        ...
                                        <input type="text" name="firstName" class="input" placeholder="First Name" value="<?php echo isset($_SESSION['firstName']) ? $_SESSION['firstName'] : $firstName; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="section-body">
                                    <div class="details">
                                        ...
                                        <input type="text" name="lastName" class="input" placeholder="Last Name" value="<?php echo isset($_SESSION['lastName']) ? $_SESSION['lastName'] : $lastName; ?>" required>
                                    </div>
                                </div>
