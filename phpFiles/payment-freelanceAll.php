<?php
    ...
    $_SESSION['payingFor'] = "freelanceAll";
    ...
    $postdata = array(
        ...
        "customizations" => array(
            "title" => "Payment for Freelancers",
            "description" => "Intrinsic Globe"
        ),

        "meta" => array(
            "reason" => "Payment for Freelancers Details",
            "address" => "Lagos state"
        ),
        "redirect_url" => "https://intrinsicglobe.com/phpFiles/verify-freelanceAll.php"
    );
