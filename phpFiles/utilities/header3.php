        ...
        <div class="profile">
            ...
            <div class="account-list">
                ...
                <div>
                    ...
                    <h2>Signed in as Employer</h2>
                </div>
                
                <a href="employer-accounts.php" class="<?php if ($page == 'employers-account') echo "active";?>">
                    <span class="fas fa-cog"></span>
                    <h4>Account</h4>
                </a>

                <a href="employer-records.php" class="<?php if ($page == 'employers-record') echo "active";?>">
                    <span class="fas fa-cog"></span>
