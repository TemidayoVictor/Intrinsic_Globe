...
class Model extends Dbh {
    ...
    public function insertDetails($username, $school, $start, $end, $level, $course) {
        $this->connect();
        $sql = "INSERT INTO education (username, institution, start, end, level, course) VALUES ('".$username."','".$school."','".$start."','".$end."','".$level."','".$course."')";
        $query = mysqli_query($this->con,$sql);
        if($query) {
            echo "Successfully Inserted";
        }
    ...
    public function insertDetails3($username, $category, $sub, $jobTitle, $salary, $jobType, $qualifications, $responsibilities, $location, $closing) {
        $this->connect();
        $sql = "INSERT INTO recruitmentemployers (username, category, subCategory, jobTitle, salary, jobType, qualifications, responsibilities, location, closing) VALUES ('".$username."','".$category."','".$sub."','".$jobTitle."','".$salary."','".$jobType."','".$qualifications."','".$responsibilities."','".$location."','".$closing."')";
        $query = mysqli_query($this->con,$sql);
        if($query) {
            echo "Successfully Inserted";
        }
    ...
    public function insertDetails4($username, $jobTitle, $salary, $category, $jobType, $sub, $expe) {
        $this->connect();   
        ...
        $sql = "INSERT INTO jobs (username, jobTitle, salary, category, jobType, subCategory, experience) VALUES ('".$username."','".$jobTitle."','".$salary."','".$category."','".$jobType."','".$sub."','".$expe."')";
        $query = mysqli_query($this->con,$sql);
        if($query) {
            echo "Successfully Inserted";
        }
        ...
        if (mysqli_num_rows($query)>0) {
            ...
            if($table == "jobs") {
                ...
                foreach ($results as $result) {
                    ...
                    $values["experience"] = $result['experience'];
                }
                return $values;
            }
    ...
    public function userLogin($username, $password) {
        ...
        if(mysqli_num_rows($query)>0 && $query!== true){
            $values = array();
            $results = mysqli_fetch_all($query, MYSQLI_ASSOC);
            foreach ($results as $result) {
                $values["id"] = $result['id'];
                $values["section"] = $result['section'];
    ...
    public function updateDb($selector, $column, $value1, $column1, $value2, $column2, $value3, $column3, $value4, $column4, $value5, $column5, $value6, $column6, $value7, $column7, $value8, $column8, $table) {
        $this->connect();
        $query = mysqli_query($this->con, "UPDATE $table SET $column1 = '$value1', $column2 = '$value2', $column3 = '$value3', $column4 = '$value4', $column5 = '$value5', $column6 = '$value6', $column7 = '$value7' , $column8 = '$value8' WHERE $column = '$selector'");
    ...
    public function updateDb3($selector, $column, $value1, $column1, $value2, $column2, $value3, $column3, $value4, $column4, $value5, $column5, $value6, $column6, $value7, $column7, $value8, $column8, $value9, $column9, $table) {
        $this->connect();
        $query = mysqli_query($this->con, "UPDATE $table SET $column1 = '$value1', $column2 = '$value2', $column3 = '$value3', $column4 = '$value4', $column5 = '$value5', $column6 = '$value6', $column7 = '$value7' , $column8 = '$value8', $column9 = '$value9' WHERE $column = '$selector'");
        $query2 = mysqli_query($this->con, "UPDATE users SET status = 'done' WHERE $column = '$selector'");
        if($query) {
            echo "Succesful";
            return true;
    ...
    public function updateDb4($selector, $column, $value1, $column1, $value2, $column2, $value3, $column3, $value4, $column4, $value5, $column5, $value6, $column6, $value7, $column7, $table) {
        $this->connect();
