<?php
    ...
    $_SESSION['payingFor'] = "candidateAll";

    $email = $_SESSION['userEmail'];
    $name = $_SESSION['repUse'];
    $amount = 1000;
    ...
    $postdata = array(
        ...
        "customizations" => array(
            "title" => "Payment for Candidates",
            "description" => "Intrinsic Globe"
        ),

        "meta" => array(
            "reason" => "Payment for Candidates Details",
            "address" => "Lagos state"
        ),
        "redirect_url" => "https://intrinsicglobe.com/phpFiles/verify-candidateAll.php"
    );
