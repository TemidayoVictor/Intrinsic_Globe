...
<body>
    ...
    <main>
        ...
        <section class="middle">
            ...
            <?php include 'phpFiles/utilities/tabs5.php';?>
            <div class="current">
            ...
            <div class="container-cover">
                ...
                <?php
                    ...
                    $query = mysqli_query($con, "SELECT * FROM freelanceemployers WHERE username = '$username' LIMIT $page_starting_limit , $results_per_page");
                    if(mysqli_num_rows($query)>0) {
                        $i = 1;
                        while($row = mysqli_fetch_array($query)) {
                            ...
                            $price = $row['budget'];    
                            $query2 = mysqli_query($con, "SELECT * FROM shortlistfree WHERE companyId = '$id'");
                ...
                <div class="container active">
                    ...
                    <div class="body">
                        <p><span>Renumeration:</span> <?php echo $price;?></p>
                        <p><span>Category:</span> <?php echo $category;?></p>
                        <p><span>Shortlists:</span> <?php echo $amount;?></p>
                    </div>
                    <div class="ending">
                        <p>Intrinsic Globe</p>
                        <a href="freemp-shortlist-view.php?companyId=<?php echo $id;?>" class="btn">View Shortlist</a>
                    </div>
                </div>
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="freemp-shortlist.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
