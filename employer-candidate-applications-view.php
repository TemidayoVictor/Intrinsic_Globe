    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <?php
                    $query = mysqli_query($con, "SELECT * FROM application WHERE company = '$username' AND companyId = '$companyId'");
                ...
                <div class="container active">
                    ...
                    <div class="content">
                        ...
                        <div class="icons">
                            <a href="employer-candidate-applications-app.php?username=<?php echo $candidate;?>" class="btn">Portfolio</a>
                        </div>
                    </div>
                </div>
