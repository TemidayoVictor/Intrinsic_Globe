...
<head>
    ...
    <title>Intrinsic Globe | Recommended Freelancer</title>
    <style>        
            a.logo img {
                width: 70%;
            }
                        ...
                        <div class="body">
                            ...
                            <div class="section">
                                ...
                                <div class="section-body" style="border-bottom: 1px solid #aaa;">
                                    ...
                                    <div class="period">
                                        <p style="font-weight: 300"><strong style="color: #011030; font-weight: 500; font-size: 2rem;">Starting Price:</strong> <?php echo $price;?></p>
                                    </div>
                                </div>
                                <?php
                                $i++;
