        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <?php
                    ...
                    $query = mysqli_query($con, "SELECT * FROM shortlistfree WHERE companyId = '$companyId' LIMIT $page_starting_limit , $results_per_page ");
                    if(mysqli_num_rows($query)>0) {
                        $i = 1;
                ...
                <div class="container active">
                    ...
                    <div class="content">
                        ...
                        <div class="icons">
                            <a href="freemp-shortlist-pro.php?username=<?php echo $candidate;?>" class="btn">Portfolio</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container active">
                    <div class="body" style="border:none;">
                        <h1>You have not shortlisted any for this job yet</h1>
                    </div>
                </div>
                <?php
                    }
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="freemp-shortlist-view.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
