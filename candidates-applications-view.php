...
if(isset($_SESSION['appStat'])) {
    $appStat = $_SESSION['appStat'];
    $appStatClass = $_SESSION['appStatClass'];
}
else {
    $appStat = "";
    $appStatClass = "";
            ...
            <div class="container-cover">
                ...
                <div class="container active selected">
                    ...
                    <div class="bottom-elements" style="margin-top: 10px; ">
                        <a href="candidates-work-profile.php" class="btn">Edit Work Profile</a>
                        <a href="phpFiles/includes/delete.php?candidate7=<?php echo $candidate?>&company7=<?php echo $username;?>&companyId7=<?php echo $idUse;?>" class="btn delete">Withdraw Application</a>
                    </div>
                </div>
