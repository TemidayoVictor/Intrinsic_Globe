        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <?php
                    ...
                    if(mysqli_num_rows($query)>0) {
                        ...
                        while($row = mysqli_fetch_array($query)) {
                            ...
                            $price = $row['budget'];    
                            $query2 = mysqli_query($con, "SELECT * FROM applicationfree WHERE companyId = '$id'");
                ...
                <div class="container active">
                    ...
                    <div class="ending">
                        <p>Intrinsic Globe</p>
                        <a href="freemp-freelance-application-view.php?companyId=<?php echo $id;?>" class="btn">View Applicants</a>
                    </div>
                </div>
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="freemp-freelancers-application.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
