...
$query = mysqli_query($con, "SELECT * from shortlist WHERE candidate = '$username' AND company = '$employer' AND companyId = '$companyId'");
if(mysqli_num_rows($query)>0){
    $state1 = "none";
    $state2 = "";
}
        ...
        <section class="middle">
            ...
            <div class="container-cover" style="border-bottom: 3px solid #ccc; display: <?php if($status != "paid") echo "none"; ?>">
                <div class="bottom-elements" style="margin-bottom: 40px;">
                    ...
                    <a href="employer-recommended-candidates.php?cat=<?php echo $categoryRec;?>" class="btn">Recommended candidates</a>
                </div>
            </div>
