...
<body>
    ...
    <main>
        ...
        <section class="middle">
            <div class="header">
                <h1>Stay Focused <?php echo $candidate;?>, and the sky won't be your limit</h1>
            </div>
            ...
            <div class="container-cover" id="cover">
                ...
                <form action="phpFiles/includes/applications.php" method="post">
                    <div class="body">
                        <p class="heading"><strong>Add Cover Letter</strong></p>
