        ...
        <section class="middle">
            ...
            <div class="current">
                ...
                <form action="phpFiles/includes/search.php" method="post" >
                    ...
                    <input type="text" name="searchForm" value="freelancer" hidden>
            ...
            <div class="container-cover">
                ...
                <?php
                    ...
                    $query = mysqli_query($con, "SELECT * FROM freelanceemployers WHERE category = '$category' AND subCategory = '$sub'");
                    if(mysqli_num_rows($query)>0) {
                    ...
                    $query = mysqli_query($con, "SELECT * FROM freelanceemployers WHERE category = '$category' AND subCategory = '$sub' LIMIT $page_starting_limit , $results_per_page ");
                    if(mysqli_num_rows($query)>0) {
                        $i = 1;
                        while($row = mysqli_fetch_array($query)) {
                            $id = $row['id'];
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="freelance-available-jobs.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
