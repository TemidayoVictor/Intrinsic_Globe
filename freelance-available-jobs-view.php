        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <div class="bottom-elements">
                    <a href="phpFiles/payment-interface.php?usernameFreeEmpAll=<?php echo $username;?>" style="display: <?php if($status == "paid") echo "none"; ?>" class="btn">Make Payment</a>
                </div>
            ...
            <form action="phpFiles/includes/signup-freelance.php" method="post" enctype="multipart/form-data" class="container-cover" id="1">
                ...
                <div class="container active selected">
                    ...
                    <div style="display: <?php echo $state2;?>" class="msg-width alert-success">Application Sucessfully Sent</div>
                    ...
                    <small style="font-size: 16px; line-height: 1.7;"> Its is imperative to know that coupled with this cover letter, the employer will have access to view your personal details, work details and other details you submitted via this platform upon completion of application</small>
