...
if(isset($_SESSION['msgFree'])) {
    $msg = $_SESSION['msgFree'];
    $msgClass = $_SESSION['msgClassFree'];
}
else {
    $msg = "";
    $msgClass = "";
...
if(isset($_SESSION['msgFree2'])) {
    $msg2 = $_SESSION['msgFree2'];
    $msgClass2 = $_SESSION['msgClassFree2'];
}
else {
    $msg2 = "";
    $msgClass2 = "";
    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <div class="container active selected" id="1" style="margin-top: -10px;">
                    <div class="body">
    
                        <form action="phpFiles/includes/signup-freelance.php" method="post" enctype="multipart/form-data">
                            <div class="section">
                                ...
                                <div class="section-body">
                                    <div class="details">
                                        ...
                                        <input type="text" class="input" name="firstName" placeholder="First Name" value="<?php echo isset($_SESSION['firstName']) ? $_SESSION['firstName'] : $firstName; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="section-body" >
                                    <div class="details">
                                        <div class="title label">Brief Description of yourself and what you do</div>
                                        <textarea style="border: 1px solid #aaa; background: #eee; height: 200px;" class="input" name="about"><?php echo isset($_SESSION['about']) ? $_SESSION['about'] : $about; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="section-body">
                                    <div class="details">
                                        <div class="title label">Change Profile Picture</div>
                                        <input type="file" name="picture" accept="image/*" style="padding: 10px 0; border: none;">
                                    </div>
                                </div>
