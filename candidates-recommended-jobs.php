...
if(mysqli_num_rows($query)>0){
    ...
    foreach ($results as $result) {
        $categoryUse = $result['category'];
        $_SESSION['category-use'] = $categoryUse;
    }    
}
else {
        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <?php
                    ...
                    $query = mysqli_query($con, "SELECT * FROM recruitmentemployers WHERE category = '$categoryUse' AND status != 'inactive'");
                    if(mysqli_num_rows($query)>0) {
                    ...
                    $query = mysqli_query($con, "SELECT * FROM recruitmentemployers WHERE category = '$categoryUse' AND status != 'inactive' LIMIT $page_starting_limit , $results_per_page ");
                    if(mysqli_num_rows($query)>0) {
                        $i = 1;
                ...
                <div class="container active">
                    ...
                    <div class="ending">
                        <p>Intrinsic Globe</p>
                        <a href="candidates-recommended-jobs-view.php?id=<?php echo $id;?>&username=<?php echo $usernameChoose;?>" class="btn">VIEW</a>
                    </div>
                </div>
                ...
                <div class="container active">
                    <div class="body" style="border:none;">
                        <h1>No Recommended Jobs Available at the moment</h1>
                    </div>
                </div>
                <?php
                    }
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="candidates-recommended-jobs.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                </div>
