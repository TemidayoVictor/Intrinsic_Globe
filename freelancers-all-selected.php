...
<body class="">
    ...
    <section class="container-section">
        <div class="title" id="start">
            <h1><span>Freelancers:</span> <?php echo $categoryChoose.' || '.$subChoose;?></h1>
        </div>
        ...
        <div class="container-all">
            <?php
                ...
                $query = mysqli_query($con, "SELECT * FROM freelancejobs WHERE category = '$categoryChoose' AND subCategory = '$subChoose' ");
                if(mysqli_num_rows($query)>0) {
                ...
                $query = mysqli_query($con, "SELECT * FROM freelancejobs WHERE category = '$categoryChoose' AND subCategory = '$subChoose' LIMIT $page_starting_limit , $results_per_page");
                if(mysqli_num_rows($query)>0) {
                    $i = 1;
                    while($row = mysqli_fetch_array($query)) {
                        $id = $row['id'];
            ...
            <div class="container active">
                <div class="body" style="border:none;">
                    <h1>No Freelancers found in ths category. Check out our other categories</h1>
                </div>
            </div>
            <?php
                }
