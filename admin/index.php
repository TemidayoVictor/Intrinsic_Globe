    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                <span class="title" style="font-size: 2.5rem;">Admin Login</span>
                ...
                <form action="phpFiles/login.php" method="post">
                    <div class="input-field">
                        <input type="text" style="font-size: 1.5rem;" placeholder="Enter username" name="username" required>
                        <i class="fas fa-user icon" style="font-size: 1.7rem;"></i>
                    </div>
                    <div class="input-field">
                        <input type="password" style="font-size: 1.5rem;" class="password" placeholder="Enter Your Password" name="password" required>
                ...
                <div class="login-signup">
                    <span class="text">Not a member?
                        <a href="index.php#start" style="font-size: 1.5rem;" class="text signup-link">Sign up</a>
                    </span>
                </div>
            </div>
