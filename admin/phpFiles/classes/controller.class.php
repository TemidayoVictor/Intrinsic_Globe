...
class Controller extends Model {
    ...
    public function createCatContr($cat) {
        $this->createCat($cat);
    }

    public function createSubContr($cat, $sub) {
        $this->createSub($cat, $sub);
    }
    ...
    public function insertDetailsContr($username, $school, $start, $end, $level) {
        return $this->insertDetails($username, $school, $start, $end, $level);
    }
    ...
    public function insertDetails3Contr($username, $category, $sub, $jobTitle, $salary, $jobType, $qualifications, $responsibilities, $gender, $closing) {
        return $this->insertDetails3($username, $category, $sub, $jobTitle, $salary, $jobType, $qualifications, $responsibilities, $gender, $closing);
    }

    public function insertDetails4Contr($username, $jobTitle, $salary, $category, $jobType, $sub) {
        return $this->insertDetails4($username, $jobTitle, $salary, $category, $jobType, $sub);
    }
