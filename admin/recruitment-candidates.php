            ...
            <div class="container-cover">
                ...
                <div class="container active">
                    ...
                    <div class="content">
                        ...
                        <div class="icons">
                            <a href="recruitment-candidates-view.php?username=<?php echo $username;?>" class="btn">Portfolio</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="recruitment-candidates.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
