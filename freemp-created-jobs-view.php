        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <div class="bottom-elements" style="margin-bottom: 20px;">
                    <a href="freemp-recommended-freelancers.php?cat=<?php echo $category;?>" class="btn">Recommended Freelancers</a>
                    <a href="phpFiles/includes/delete.php?id9=<?php echo $idUse;?>" class="btn btn2">Delete Job</a>
                </div>
            ...
            <div class="container-cover" style="border-bottom: 3px solid #ccc;">
                ...
                <div class="bottom-elements">
                    <input id="brandLink" style="border-bottom:none; background-color: transparent; font-size: 1.5rem; user-select: all;" value="https://intrinsicglobe.com/freemp-jobs.php?id=<?php echo $idUse;?>&username=<?php echo $username;?>" readonly>
                </div>
