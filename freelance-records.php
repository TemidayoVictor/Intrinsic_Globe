        ...
        <section class="middle">
            ...
            <div class="container-cover" style="display: flex; align-item:start; justify-content: start;">
                <form action="phpFiles/includes/subscription-interface.php" method="post">
                    ...
                    <div class="input-box">
                        <input type="text" name="track" value="freelancer" hidden>
                    </div>
                </form>
            </div>
            ...
            <div class="container-cover">
                ...
                <?php
                    ...
                    $query = mysqli_query($con, "SELECT * FROM paymentfreelanceemp WHERE paidBy = '$username'");
                    if(mysqli_num_rows($query)>0) {
                    ...
                    $query1 = mysqli_query($con, "SELECT * FROM paymentfreelanceemp WHERE paidBy = '$username'"); 
                    if(mysqli_num_rows($query1)>0) {
                        ...
                        while($row = mysqli_fetch_array($query1)) {
                            ...
                            $query = mysqli_query($con, "SELECT * FROM freelanceemployers WHERE username = '$paidFor'");
                            if(mysqli_num_rows($query)>0) {
                                $i = 1;
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="freelance-records.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
