        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                <div class="bottom-elements" >
                    <a href="phpFiles/payment-interface.php?usernameEmployerAll=<?php echo $username;?>" style="display: <?php if($status == "paid") echo "none"; ?>" class="btn">Make Payment</a>
                </div>

            </div>
            
            <!--<div class="container-cover" id="cover">
                
                <div class="container active selected">
                <form action="phpFiles/includes/applications.php" method="post">
                    <div class="body">
                        <p class="heading"><strong>Cover Letter</strong></p>

                        <div style="display: <?php echo $state2;?>" class="msg-width alert-success">Application already Sent</div>

                        <textarea type="text" name="cover" style="font-size: 17px; background-color: #eee; padding:15px; width:100%; height: 200px; border: 2px solid #eee;" required></textarea>
                    </div>

                    <div class="input-box">
                        <input type="text" name="candidate" value="<?php echo $candidate;?>" hidden>
                    </div>
                    <div class="input-box">
                        <input type="text" name="company" value="<?php echo $username;?>" hidden>
                    </div>
                    <div class="input-box">
                        <input type="text" name="companyId" value="<?php echo $idUse;?>" hidden>
                    </div>

                    <div class="bottom-elements" style="margin-bottom: 40px;">
                        <input style="display: <?php echo $state1;?>" type="submit" class="btn" value="Apply for Job">
                        <a href="candidates-applications.php" style="display: <?php echo $state2;?>" class="btn">View All Applications</a>
                    </div>
                </form>
                </div>
