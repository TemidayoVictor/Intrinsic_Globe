        ...
        <section class="middle">
            ...
            <div class="container-cover">
                <?php
                    ...
                    $query = mysqli_query($con, "SELECT * FROM freelanceemployers WHERE username = '$username' ORDER BY id DESC LIMIT $page_starting_limit , $results_per_page ");
                    if(mysqli_num_rows($query)>0) {
                        $i = 1;
                ...
                <div class="container active">
                    ...
                    <div class="body">
                        <p><span>Budget: </span> <?php echo $budget;?></p>
                        <p><span>Category: </span> <?php echo $category;?></p>
                        <p><span>Sub-Category: </span> <?php echo $subCategory;?></p>
                    </div>
                    <div class="ending">
                        <p>Intrinsic Globe</p>
                        <a href="freemp-created-jobs-view.php?id=<?php echo $id;?>&username=<?php echo $username;?>" class="btn">VIEW</a>
                    </div>
                </div>
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="freemp-created-jobs.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
