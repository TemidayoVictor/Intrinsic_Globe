    ...
    <main>
        ...
        <section class="middle">
            ...
            <div class="container-cover">
                ...
                $query = mysqli_query($con, "SELECT * FROM shortlist WHERE candidate = '$username'");
                ...
                $query = mysqli_query($con, "SELECT * FROM shortlist WHERE candidate = '$username' LIMIT $page_starting_limit , $results_per_page ");
                if(mysqli_num_rows($query)>0) {
                    $i = 1;
                ...
                <div class="container">
                    ...
                    <div class="body">
                        ...
                        <p><span>Payment Status: <span style="text-decoration: line-through;"><?php echo $status;?></span> Free [trial] </span></span> </p>
                    </div>
                    <div class="ending">
                        <p>Intrinsic Globe</p>
                        <a href="candidates-shortlisting-view.php?id=<?php echo $companyId;?>&username=<?php echo $usernameChoose;?>" class="btn">View</a>
                    </div>
                </div>
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="candidates-shortlisting.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
