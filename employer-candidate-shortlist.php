            ...
            <div class="container-cover">
                ...
                <?php
                    ...
                    if(mysqli_num_rows($query)>0) {
                        ...
                        while($row = mysqli_fetch_array($query)) {
                            ...
                            $query2 = mysqli_query($con, "SELECT * FROM shortlist WHERE companyId = '$id'");
                ...
                <div class="container active">
                    ...
                    <div class="body">
                        ...
                        <p><span>Shortlistings: </span> <?php echo $amount;?></p>
                    </div>
                    <div class="ending">
                        <p>Intrinsic Globe</p>
                        <a href="employer-candidate-shortlist-view.php?companyId=<?php echo $id;?>" class="btn">View shortlists</a>
                    </div>
                </div>
                ...
                <div class="bottom-elements">
                    ...
                    ?>
                        <a href="employer-candidate-shortlist.php?pageId=<?php echo $i;?>"> <div><?php echo $i;?></div> </a>
                    <?php
                    }
                    ?>
                    </div>
